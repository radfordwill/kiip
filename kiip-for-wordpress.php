...
class kiip_for_wordpress {
    ...
    function __construct() {
        ...
        if ( is_admin() ) {
            ...
            add_action( $admin_menu, array( & $admin, 'kiip_admin_menu' ) );
    ...
    function enqueue_styles_public( $file_name = '' ) {
        ...
        wp_enqueue_style( NAME, plugin_dir_url( __FILE__ ) . 'public/css/kiip-for-wordpress-public.css', array(), self::VERSION, 'all' );
    }
    ...
    function enqueue_styles_admin() {
         ...
         * class.
         */
        wp_enqueue_style( NAME, plugin_dir_url( __FILE__ ) . 'admin/css/kiip-for-wordpress-admin.css', array(), self::VERSION, 'all' );
    }
    ...
    function enqueue_scripts_admin() {
         ...
         * class.
         */
        wp_enqueue_script( NAME, plugin_dir_url( __FILE__ ) . 'admin/js/kiip-for-wordpress-admin.js', array( 'jquery' ), self::VERSION, false );
    }
    ...
    function kiip_ad_shortcodes( $atts, $content ) {
        ...
        //return self::FOLDERNAME.'/'.$file_name;
